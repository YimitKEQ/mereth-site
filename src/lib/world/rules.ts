...
export const ruleSections: RuleSection[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      { code: "T.4", text: "In-universe prejudice rooted in Elder Scrolls lore is permitted: Nordic distrust of elves, Dunmer views on outsiders, and so on. It must stay strictly in character, and must never be a cover for real-world bigotry or used to make another player genuinely uncomfortable." },
      { code: "T.5", text: "Smack talk is allowed, with a line. Players may give their characters handicaps such as missing limbs, chronic illness or speech impediments. These may be referenced in character until the player says it should go no further. Continuing after that is toxicity." },
